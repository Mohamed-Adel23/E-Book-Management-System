...
namespace EBMS.API.Controllers.V1
{
    ...
    [ApiVersion("1.0")]
    [ApiController]
    [EnableRateLimiting(RateLimiterConstants.Concurrency)]
    [Authorize]
    public class OrdersController : ControllerBase
    {
        ...
        // Payment Endpoint
        [HttpPost("Payment/{id:int}", Name = "orderPayment")]
        public async Task<IActionResult> OrderPaymentAsync(int id, string Cancel = null, string PayerID = "", string guid = "")
        {
            ...
            else
            {
                ...
                // Send Email To Notify All Admins with the new Order
                await _unitOfWork.SendEmail.SendOrderEmail(id, "New Order Submitted!", result.Amount);
